...
class ChatList extends Component
{
    ...
    public function chatUserSelected(Conversation $conversation, $receiverId)
    {
        ...
        $this->emitTo('chat.chatbox', 'loadConversation', $this->selectedConversations, $receiverInstance);
        $this->emitTo('chat.send-message', 'updateSendMessage', $this->selectedConversations, $receiverInstance);
    }
